                                ...
                                <div class="card-body">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select class="form-control @error('subcategory_id') is-invalid @enderror"
                                                ...
                                                @foreach ($subcategory as $sub)
                                                    <option value="{{ $sub->id }}"
                                                        @if ($sub->id == $product->subcategory_id) selected @endif>
                                            ...
                                            <select class="form-control" name="childcategory_id" id="childcategory_id">
                                                ...
                                                @foreach ($childcategory as $child)
                                                    <option value="{{ $child->id }}"
                                                        @if ($child->id == $product->childcategory_id) selected @endif>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select class="form-control" name="pickup_point" id="pickup_point">
                                                ...
                                                @foreach ($pickuppoint as $pickpoint)
                                                    <option value="{{ $pickpoint->id }}" @if($product->pickup_point == $pickpoint->id) selected @endif>{{ $pickpoint->pickUpPointName }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="number" class=form-control name="unit"
                                                value="{{ $product->unit }}" placeholder="Enter Product Unit">
                                        </div>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select class="form-control @error('warehouse_id') is-invalid @enderror"
                                                ...
                                                @foreach ($warehouse as $warehouse)
                                                    <option value="{{ $warehouse->id }}" @if($product->warehouse_id == $warehouse->id) selected @endif>{{ $warehouse->warehouse_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('warehouse_id')
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $product->color }}" data-role="tagsinput" name="color"
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ $product->size }}" data-role="tagsinput" name="size"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input class="form-control" name="video" value="{{ $product->video }}"
