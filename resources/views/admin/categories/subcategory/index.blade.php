                                ...
                                <table id="example1" class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="" class="btn btn-primary edit" data-id= "{{$subcat->id}}" data-toggle="modal" data-target="#editModal"><i
                                                        class="fas fa-edit"></i></a>
                                                <a href="{{route('subcategory.delete',$subcat->id)}}" class="btn btn-danger" id="delete"><i
