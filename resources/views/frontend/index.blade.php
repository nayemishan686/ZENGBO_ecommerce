                        ...
                        <div class="deals">
                            ...
                            <div class="deals_slider_container">
                                ...
                                <div class="owl-carousel owl-theme deals_slider">
                                    @foreach ($todayDealProduct as $item)
                                        <!-- Deals Item -->
                                        <div class="owl-item deals_item">
                                            ...
                                            <div class="deals_content">
                                                <div class="deals_info_line d-flex flex-row justify-content-center">
                                                    <div class="deals_item_category"><a
                                                            href="#">{{ $item->category->category_name }}</a>
                                                    </div>
                                                    <div class="deals_item_price_a ml-auto">
                                                        @if($item->discount_price != null)
                                                        <del class="text-danger">{{ $setting->currency }}{{ $item->selling_price }}</del>
                                                        @endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="available">
                                                    <div class="available_line d-flex flex-row justify-content-start">
                                                        <div class="available_title">Available: <span>{{$item->stock_quantity}}</span></div>
                        ...
                        <div class="featured">
                            <div class="tabbed_container">
                                ...
                                <div class="product_panel panel">
                                    <div class="featured_slider slider">
                                        <!-- Slider Item -->
                                        @foreach ($MostPopularProduct as $item)
                                            <div class="featured_slider_item p-3">
                                                <div class="border_active"></div>
                                                <div
                                                    class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                    ...
                    <div class="col-lg-3">
                        <div class="trends_container">
                            ...
                            <div class="trends_text">
                                <p>In this year, Most trending product are these.</p>
                            </div>
                        ...
                        <div class="trends_slider_container">
                            ...
                            <div class="owl-carousel owl-theme trends_slider">
                                ...
                                @foreach ($TrendyProduct as $item)
                                    <div class="owl-item" style="cursor: pointer">
                                        <div class="trends_item is_new">
                                            ...
                                            <div class="trends_content">
                                                <div class="trends_category"><a
                                                        href="{{ route('product.details', $item->slug) }}">{{ substr($item->name, 0, 30) }}</a>
                                                </div>
                                                <div class="trends_info clearfix pt-2">
                                                    <div class="trends_name"><a
                                                            href="#">{{ $item->brand->brand_name }}</a></div>
                                            ...
                                            <ul class="trends_marks">
                                                ...
                                                <li class="trends_mark trends_new"><i class="fas fa-eye"></i></li>
                                            </ul>
                                            @if (Auth::id())
                                                <a href="{{ route('add.wishlist', $item->id) }}" class="trends_fav"
                                                    style="cursor: pointer"><i class="fas fa-heart"></i></a>
                                            @else
                                                <div class="trends_fav alert_wishlist"><i class="fas fa-heart"></i>
                                                </div>
                                            @endif
                            ...
                            <div class="owl-carousel owl-theme brands_slider">
                                ...
                                <div class="owl-item">
                                    <div class="brands_item d-flex flex-column justify-content-center"><img
                                            src="{{ asset('public/frontend') }}/images/brands_1.jpg" alt="">
                                    </div>
                                </div>
                                <div class="owl-item">
                                    <div class="brands_item d-flex flex-column justify-content-center"><img
                                            src="{{ asset('public/frontend') }}/images/brands_2.jpg" alt="">
                                    </div>
                                </div>
                                <div class="owl-item">
                                    <div class="brands_item d-flex flex-column justify-content-center"><img
                                            src="{{ asset('public/frontend') }}/images/brands_3.jpg" alt="">
                                    </div>
                                </div>
                                <div class="owl-item">
                                    <div class="brands_item d-flex flex-column justify-content-center"><img
                                            src="{{ asset('public/frontend') }}/images/brands_4.jpg" alt="">
                                    </div>
                                </div>
                                <div class="owl-item">
                                    <div class="brands_item d-flex flex-column justify-content-center"><img
                                            src="{{ asset('public/frontend') }}/images/brands_5.jpg" alt="">
                                    </div>
                                </div>
                                <div class="owl-item">
                                    <div class="brands_item d-flex flex-column justify-content-center"><img
                                            src="{{ asset('public/frontend') }}/images/brands_6.jpg" alt="">
                                    </div>
                                </div>
                                <div class="owl-item">
                                    <div class="brands_item d-flex flex-column justify-content-center"><img
                                            src="{{ asset('public/frontend') }}/images/brands_7.jpg" alt="">
                                    </div>
                                </div>
                                <div class="owl-item">
                                    <div class="brands_item d-flex flex-column justify-content-center"><img
                                            src="{{ asset('public/frontend') }}/images/brands_8.jpg" alt="">
                                    </div>
                                </div>
